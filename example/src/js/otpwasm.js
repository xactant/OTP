...
Module["moduleLoaded"] = new Observable();
Module["arguments"] = [];
...
function staticAlloc(size) {
  console.log("staticAlloc size=" + size);
    var ret = STATICTOP;
...
function alignMemory(size, factor) {
  console.log("alignMemory size=" + size + " factor=" + factor);
...
function assert(condition, text) {
  console.log("assert condition=" + condition + " text=" + text);
    if (!condition) {
...
function Pointer_stringify(ptr, length) {
  console.log("Pointer_stringify ptr=" + ptr + " length=" + length);
...
function getWasmFromEthereum() {
  return new Promise(function (resolve,reject) {
    var binary_string =  window.atob(OtpCI.wasmData.getValue());
    ...
    var response = {"ok": true, "arrayBuffer": bytes.buffer};
    resolve ( response);
  });
}

function integrateWasmJS(d) {
  console.log("integrateWasmJS");
    ...
    function getBinaryPromise() {
        ...
        if (!Module["wasmBinary"] && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) && typeof fetch === "function") {
            return getWasmFromEthereum().then(function(result) {
                if (!result["ok"]) {
    ...
    function doNativeWasm(global, env, providedBuffer) {
        ...
        function instantiateArrayBuffer(receiver) {
            ...
            getBinaryPromise().then((function(binary) {
                console.log("WebAssembly.instantiate(binary, info)")
    ...
    // Broadcast WASM module loaded.
    Module["moduleLoaded"].setValue(true);
}
...
function wasmProcessor () {
  ...
  Module["wasmTableSize"] = 486;
  Module["wasmMaxTableSize"] = 486;
  Module.asmGlobalArg = {};
  ...
  var __GLOBAL__sub_I_otp_cc = Module["__GLOBAL__sub_I_otp_cc"] = (function() {
